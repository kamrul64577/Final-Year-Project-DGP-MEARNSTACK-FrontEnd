...
function Dashboard(props) {
    ...
    const drawer = (
        <div>
            ...
            {!admin && <Box>
                ...
                <br />
                <Link style={{ textDecoration: 'none' }} to={`${url}/myOrders`}><Button className="bg-dark text-light my-2">My Orders</Button></Link>
                <br />
            ...
            {admin && <Box >
                ...
                <Link style={{ textDecoration: 'none' }} to={`${url}/allProducts`}><Button className="my-2 bg-dark text-light">Manage All Products</Button></Link>


            </Box>}
            <Button className="text-light bg-dark" onClick={logOut} color="inherit">Logout</Button>
            {/* <List>
    ...
    return (
        <Box sx={{ display: 'flex' }}>
            ...
            >
                <Toolbar />
                <h1 className="text-center">Welcome to Our Dashboard</h1>
                <Switch>
